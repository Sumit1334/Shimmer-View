...
public class Shimmer {
  ...
  public abstract static class Builder<T extends Builder<T>> {
    ...
    T consumeAttributes(TypedArray a) {
      if (true) {
        setClipToChildren(mShimmer.clipToChildren);
      }
      if (true) {
        setAutoStart(mShimmer.autoStart);
      }
      if (true) {
        setBaseAlpha(0.3f);
      }
      ...
      if (true) {
        setDuration( (int) mShimmer.animationDuration);
      }
      if (true) {
        setRepeatCount(mShimmer.repeatCount);
      }
      if (true) {
        setRepeatDelay((int) mShimmer.repeatDelay);
      }
      if (true) {
      ...
      if (true) {
        int direction = mShimmer.direction;
        switch (direction) {
          default:
      ...
      if (true) {
        setDropoff(( mShimmer.dropoff));
      }
      if (true) {
        setFixedWidth(mShimmer.fixedWidth);
      }
      if (true) {
        setFixedHeight(mShimmer.fixedHeight);
      }
      if (true) {
        setIntensity((mShimmer.intensity));
      }
      if (true) {
        setWidthRatio((mShimmer.widthRatio));
      }
      if (true) {
        setHeightRatio((mShimmer.heightRatio));
      }
      if (true) {
        setTilt(mShimmer.tilt);
      }
      return getThis();
    }
